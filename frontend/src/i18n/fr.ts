...
const fr: Dictionary = {
  ...
  track: {
    ...
    stageCompleted: 'Terminée',
    myOrdersTitle: 'Mes commandes',
    myOrdersLead: 'Consulte et suis toutes tes commandes au même endroit.',
    tabAll: 'Toutes',
    ...
    noOrdersYet: 'Pas encore de commande. La première apparaîtra ici.',
    noOrdersInTab: 'Rien ici pour l’instant.',
    guestLookupOpen: 'Tu cherches une commande passée sans compte ?',
    ...
    credBackupCodesHint: 'Trois codes de huit chiffres, exactement comme EA les fournit.',
  ...
  order: {
    ...
    boostPlatformPc: 'PC',
    boostPlatformNeeded: 'Choisis une plateforme pour continuer.',
    launcherLabel: 'Avec quel launcher joues-tu à FC ?',
    launcherHint: 'Sur PC la connexion change selon le launcher, il nous faut le bon.',
    launcherPlaceholder: 'Choisis ton launcher',
    launcherSteam: 'Steam',
    launcherEaApp: 'EA app',
    launcherEpic: 'Epic Games',
    launcherNeeded: 'Choisis ton launcher pour continuer.',
    ...
    testingTitle: 'Les paiements sont en test',
    testingBody:
      'Notre système de paiement est encore en cours d’ajustement. Nous prenons toutes les ' +
      'précautions et ta commande est traitée comme d’habitude, mais si quelque chose semble ' +
      'incorrect sur cet écran, arrête-toi et parle-nous avant de payer.',
    testingContact: 'Contacter l’assistance',
    ...
    payIntlBody: (methods: string[]) =>
      `Pour l’instant, utilise ${methods.join(' ou ')} pour les commandes internationales.`,
    payIntlNote: 'C’est ici qu’apparaîtront d’autres moyens de payer depuis l’étranger.',
    payIntlUse: (method: string) => `Payer avec ${method}`,
    ...
    payProofLabel: 'Capture du paiement',
    payProofHint: 'L’écran de confirmation que ton application de paiement affiche après l’envoi — un JPG, PNG ou WebP de moins de 5 Mo.',
    ...
    payProofFailed: 'Ta référence a été enregistrée, mais la capture n’a pas été envoyée. Joins-la à nouveau ci-dessous.',
    payProofRequired: 'Joins une capture du paiement avant d’envoyer.',
    payProofRetry: 'Envoyer la capture',
  ...
  coachingPage: {
    seoDescription: (season: string): string =>
      `Coaching individuel EA ${season} centré sur ton jeu : on regarde comment tu joues, on repère ` +
      `ce qui te coûte des matchs et on te donne des changements applicables. Séance à l’unité ou pack de six.`,
    eyebrow: (season: string): string => `${season} · Coaching`,
    title: 'Progresse volontairement, pas par hasard',
    lead:
      'Un coaching EA FC individuel construit autour de ton jeu, de tes habitudes et de ce qui te freine. ' +
    ...
    heroAlt: 'Un joueur avec un casque analysant un match sur un écran',
    singleBody:
      'Une séance individuelle centrée sur ton jeu. Repère les plus gros problèmes de ton jeu et ' +
      'repars avec des ajustements clairs à travailler.',
    packBody:
      'Six séances pour travailler ton jeu dans la durée. Utilise-les à ton rythme au cours du mois ' +
      'et construis sur chaque séance.',
    buySession: 'Acheter une séance',
    buyPackage: 'Acheter le pack',
    saveBadge: (pct: number): string => `−${pct} %`,
    processEyebrow: 'Notre méthode',
    processTitle: 'Que se passe-t-il vraiment pendant une séance ?',
    processAside: 'Une méthode simple, centrée sur ta progression.',
    watchTitle: 'On observe',
    watchBody: 'On regarde comment tu joues vraiment, pas seulement le score final.',
    findTitle: 'On repère',
    findBody: 'Les décisions, habitudes et schémas qui te coûtent des matchs.',
    fixTitle: 'On corrige',
    fixBody: 'Tu reçois des changements concrets pour ton jeu, ta tactique et tes prises de décision.',
    applyTitle: 'Tu appliques',
    applyBody: 'Repars avec quelque chose que tu peux vraiment utiliser dans tes prochains matchs.',
    coachEyebrow: 'Ton coach',
    coachTitleLine: 'Coach EA FC · Jeu et FUT Champions',
    coachBio:
      'Plus de 5 ans d’expérience en compétition. Des gestes techniques et schémas offensifs à la défense, ' +
      'la prise de décision et le mental : développe le jeu complet dont tu as besoin pour performer au plus haut niveau.',
    specialtiesLabel: 'Spécialités',
    specialties: ['Attaque', 'Défense', 'Prise de décision', 'FUT Champions', 'Tactique'],
    languagesLabel: 'Langues :',
    languagesValue: 'Anglais, hindi',
    coachQuote: 'Mon objectif est simple : t’aider à comprendre ton jeu et à progresser régulièrement.',
    viewProfile: 'Réserve ta séance',
    coachPhotoAlt: 'Vinay, coach EA FC',
    areasEyebrow: 'Sur quoi peut-on travailler ?',
    areasTitle: 'Les points qu’on peut t’aider à améliorer',
    areasAside: 'Que tu débutes ou que tu sois compétiteur, le coaching s’adapte à tes objectifs.',
    areas: [
      { key: 'attacking', title: 'Attaque', body: 'Crée de meilleures occasions et prends de meilleures décisions dans le dernier tiers.' },
      { key: 'defending', title: 'Défense', body: 'Améliore ton placement, tes changements de joueur et tes décisions défensives.' },
      { key: 'buildup', title: 'Construction', body: 'Comprends quand avancer, conserver le ballon ou changer de rythme.' },
      { key: 'tactics', title: 'Tactique', body: 'Construis un système adapté à ton style au lieu de suivre aveuglément la dernière méta.' },
      { key: 'decisions', title: 'Prise de décision', body: 'Réduis les erreurs inutiles et fais de meilleurs choix sous pression.' },
      { key: 'champs', title: 'FUT Champions', body: 'Gagne en régularité et fais davantage compter tes bonnes performances.' },
    ],
    reviewsEyebrow: 'Avec leurs mots',
    reviewsTitle: 'Ce que nos clients ont dit',
    ctaTitle1: 'Le but n’est pas de jouer plus de matchs.',
    ctaTitle2: 'C’est de jouer de meilleurs matchs.',
    ctaBody:
      'Jouer 100 matchs de plus ne corrige pas forcément les mêmes erreurs. Découvre ce qui te freine vraiment.',
  ...
  boostingCheckout: {
    ...
    discordDetailsTitle: 'Infos du compte via Discord',
    discordDetailsLead: 'Pour ta sécurité, nous ne demandons pas tes identifiants EA sur le site.',
    discordDetailsCallout: 'Après le paiement, tu seras mis en relation avec notre équipe sur Discord.',
    discordDetailsPoint1: 'Tes identifiants EA ne sont demandés que dans ton ticket Discord privé.',
  ...
  coachingBook: {
    ...
    stepDetails: 'Infos',
    stepPayment: 'Paiement',
    chooseTitle: 'Choisis ton option de coaching',
    chooseLead: 'Choisis l’option adaptée à tes objectifs. Tu pourras toujours passer au pack plus tard.',
    singleBullets: ['Séance individuelle en direct', 'Analyse de ton jeu', 'Conseils personnalisés', 'Points d’action clairs'],
    packBullets: ['À ton rythme', 'Suivi de ta progression', 'Horaires flexibles', 'Meilleur prix'],
    saveBadge: (pct: number): string => `−${pct} %`,
    unsureTitle: 'Tu hésites entre les deux ?',
    unsureBody: 'Dans le doute, commence par une séance. Tu pourras toujours prendre le pack plus tard.',
    continue: 'Continuer',
    signInToContinue: 'Connecte-toi pour continuer',
    signInWhy: 'Ton coaching est lié à ton compte, pour que tes séances et tes points restent avec toi.',
    detailsTitle: 'Parle-nous un peu de toi',
    detailsLead: 'Ça nous aide à préparer ta séance.',
    handleLabel: 'ID EA FC / PSN / Xbox',
    handlePlaceholder: 'Saisis ton ID en jeu (ex. VinayFC10)',
    handleRequired: 'Saisis ton ID en jeu pour que ton coach puisse te trouver.',
    platformLabel: 'Plateforme',
    platformRequired: 'Choisis la plateforme sur laquelle tu joues.',
    platformPlayStation: 'PlayStation',
    platformXbox: 'Xbox',
    platformPc: 'PC (EA App)',
    rankLabel: 'Rang / Division actuelle',
    rankPlaceholder: 'Choisis ton rang actuel',
    rankDivision: (n: number): string => `Division ${n}`,
    rankElite: 'Division Élite',
    rankNotSure: 'Je ne sais pas',
    focusLabel: 'Que veux-tu améliorer ?',
    focusPlaceholder: 'ex. défense, attaque, tactique, prise de décision...',
    optional: '(Facultatif)',
    reviewTitle: 'Vérifie ta commande',
    coachingSession: 'Séance de coaching',
    summaryPlatform: 'Plateforme',
    summaryHandle: 'ID en jeu',
    summaryRank: 'Rang actuel',
    summaryFocus: 'Point à améliorer',
    orderSummary: 'Récapitulatif',
    total: 'Total',
    paymentMethod: 'Moyen de paiement',
    recommended: 'Recommandé',
    payOnlineTitle: 'Payer en ligne',
    payOnlineBody: 'UPI, carte bancaire et virement en ligne',
    payUpiTitle: 'UPI',
    payUpiBody: 'Scanne et paie depuis n’importe quelle application UPI',
    payPaypalTitle: 'PayPal',
    payPaypalBody: 'Pour les paiements depuis l’étranger',
    payCryptoTitle: 'Crypto',
    payCryptoBody: 'USDT sur le réseau TRON',
    acceptPrefix: 'J’accepte les',
    terms: 'Conditions d’utilisation',
    and: 'et la',
    privacy: 'Politique de confidentialité',
    acceptRequired: 'Accepte les conditions pour continuer.',
    payNow: 'Payer',
    payCaptionOnline: 'Paiement sécurisé par notre partenaire de paiement',
    payCaptionManual: 'L’écran suivant t’indique où envoyer le paiement.',
    trustTitle: 'Tes informations sont protégées',
    trustEncrypted: 'Envoyées via une connexion chiffrée',
    trustPurpose: 'Utilisées uniquement pour préparer et assurer ton coaching',
    trustPayments: 'Nous ne voyons jamais tes données de carte ni ton accès bancaire',
    placeFailed: 'Impossible de passer cette commande. Réessaie.',
    loadOrderFailed: 'Impossible de charger cette commande.',
    processingTitle: 'Paiement en cours...',
    processingBody: 'Cela ne prendra que quelques secondes.',
    stageSecuring: 'Sécurisation du paiement',
    stageVerifying: 'Vérification de la transaction',
    stageFinalising: 'Finalisation de la commande',
    doNotClose: 'Ne ferme pas cette page pendant que nous confirmons ton paiement.',
    processingSlow:
      'C’est plus long que d’habitude. Ton paiement est en sécurité : cette page avancera dès qu’il sera confirmé.',
    successTitle: 'Paiement réussi !',
    successBody: 'Ta séance de coaching est confirmée.',
    submittedTitle: 'Paiement envoyé',
    submittedBody: 'Nous le vérifions sur notre compte. Cette page se met à jour toute seule dès qu’il est confirmé.',
    ...
    backToCoaching: 'Retour au coaching',
  },
  coaching: {
