...
const en = {
  ...
  track: {
    ...
    credBackupCodesHint: 'Three codes, eight digits each, exactly as EA issued them.',
  ...
  coachingPage: {
    seoDescription: (season: string): string =>
      `One-to-one EA ${season} coaching built around your gameplay: we watch how you play, find ` +
      `what is costing you games and give you changes you can apply. Single session or a six-session package.`,
    eyebrow: (season: string): string => `${season} · Coaching`,
    title: 'Get better on purpose, not by accident',
    lead:
      'One-to-one EA FC coaching built around your gameplay, your habits and the areas holding you ' +
    ...
    heroAlt: 'A player in headphones studying a match on a monitor',
    singleBody:
      'A focused one-to-one session built around your gameplay. Identify the biggest issues in your ' +
      'game and leave with clear adjustments to work on.',
    packBody:
      'Six focused sessions to work through your game over time. Use them at your own pace ' +
      'throughout the month and build on each session.',
    buySession: 'Buy a session',
    buyPackage: 'Buy the package',
    saveBadge: (pct: number): string => `Save ${pct}%`,
    processEyebrow: 'Our process',
    processTitle: 'What actually happens in a session?',
    processAside: 'A simple process, focused on your improvement.',
    watchTitle: 'We watch',
    watchBody: 'We look at how you actually play, not just the final score.',
    findTitle: 'We find',
    findBody: 'The decisions, habits and patterns costing you games.',
    fixTitle: 'We fix',
    fixBody: 'You get practical changes to your gameplay, tactics and decision making.',
    applyTitle: 'You apply',
    applyBody: 'Leave with something you can actually use in your next games.',
    coachEyebrow: 'Meet your coach',
    coachTitleLine: 'EA FC Coach · Gameplay & FUT Champions',
    coachBio:
      '5+ Years of Competitive Experience. From skill moves & attacking patterns to defending, ' +
      'decision-making and mentality, develop the complete game needed to compete at your best.',
    specialtiesLabel: 'Specialities',
    specialties: ['Attacking', 'Defending', 'Decision Making', 'FUT Champions', 'Tactics'],
    ...
    areasAside: 'Whether you’re a beginner or a competitive player, coaching is built around your goals.',
    areas: [
      { key: 'attacking', title: 'Attacking', body: 'Create better chances and make your final-third decisions more effective.' },
      { key: 'defending', title: 'Defending', body: 'Improve positioning, switching and defensive decision making.' },
      { key: 'buildup', title: 'Build-up', body: 'Understand when to play forward, recycle possession or change the tempo.' },
      { key: 'tactics', title: 'Tactics', body: 'Build a setup around your playstyle instead of blindly following the latest meta.' },
      { key: 'decisions', title: 'Decision Making', body: 'Reduce unnecessary mistakes and make better choices under pressure.' },
      { key: 'champs', title: 'FUT Champions', body: 'Improve consistency and make more of your good performances count.' },
    ],
    reviewsEyebrow: 'In their words',
    reviewsTitle: 'What customers actually said',
    ctaTitle1: 'The goal isn’t more games.',
    ctaTitle2: 'It’s better games.',
    ctaBody:
      'Playing another 100 matches doesn’t necessarily fix the same mistakes. Figure out what’s ' +
  ...
  coachingBook: {
    ...
    stepDetails: 'Details',
    stepPayment: 'Payment',
    chooseTitle: 'Choose your coaching option',
    chooseLead: 'Pick the option that fits your goals. You can always upgrade later.',
    singleBullets: ['One-to-one live session', 'Gameplay analysis', 'Personalised advice', 'Clear action points'],
    packBullets: ['Use at your own pace', 'Progress tracking', 'Flexible scheduling', 'Better value'],
    saveBadge: (pct: number): string => `Save ${pct}%`,
    unsureTitle: 'Not sure which option to choose?',
    unsureBody: 'If you’re unsure, start with a single session. You can always get the package later.',
    continue: 'Continue',
    signInToContinue: 'Sign in to continue',
    signInWhy: 'Your coaching is linked to your account, so your sessions and points stay with you.',
    detailsTitle: 'Tell us a bit about yourself',
    detailsLead: 'This helps us prepare for your session.',
    handleLabel: 'EA FC ID / PSN / Xbox ID',
    handlePlaceholder: 'Enter your in-game ID (e.g. VinayFC10)',
    handleRequired: 'Enter your in-game ID so your coach can find you.',
    platformLabel: 'Platform',
    platformRequired: 'Choose the platform you play on.',
    platformPlayStation: 'PlayStation',
    platformXbox: 'Xbox',
    platformPc: 'PC (EA App)',
    rankLabel: 'Current Rank / Division',
    rankPlaceholder: 'Select your current rank',
    rankDivision: (n: number): string => `Division ${n}`,
    rankElite: 'Elite Division',
    rankNotSure: 'Not sure',
    focusLabel: 'What do you want to improve?',
    focusPlaceholder: 'e.g. Defending, attacking, tactics, decision making...',
    optional: '(Optional)',
    reviewTitle: 'Review your order',
    coachingSession: 'Coaching session',
    summaryPlatform: 'Platform',
    summaryHandle: 'In-game ID',
    summaryRank: 'Current rank',
    summaryFocus: 'Improvement focus',
    orderSummary: 'Order summary',
    total: 'Total',
    paymentMethod: 'Payment method',
    recommended: 'Recommended',
    payOnlineTitle: 'Pay online',
    payOnlineBody: 'UPI, credit or debit card, and net banking',
    payUpiTitle: 'UPI',
    payUpiBody: 'Scan and pay from any UPI app',
    payPaypalTitle: 'PayPal',
    payPaypalBody: 'For payments from outside India',
    payCryptoTitle: 'Crypto',
    payCryptoBody: 'USDT on the TRON network',
    ...
    payNow: 'Pay now',
    payCaptionOnline: 'Secure payment powered by our payment partner',
    payCaptionManual: 'You’ll see where to send the payment on the next screen.',
    trustTitle: 'Your information is safe',
    trustEncrypted: 'Sent over an encrypted connection',
    trustPurpose: 'Used only to prepare and run your coaching',
    trustPayments: 'We never see your card or bank login',
    placeFailed: 'We could not place that order. Try again.',
    loadOrderFailed: 'We could not load that order.',
    processingTitle: 'Processing your payment...',
    processingBody: 'This will only take a few seconds.',
    stageSecuring: 'Securing payment',
    stageVerifying: 'Verifying transaction',
    stageFinalising: 'Finalising order',
    doNotClose: 'Please do not close this page while we confirm your payment.',
    processingSlow:
      'This is taking longer than usual. Your payment is safe — this page moves on the moment it is confirmed.',
    successTitle: 'Payment successful!',
    successBody: 'Your coaching session has been confirmed.',
    submittedTitle: 'Payment submitted',
    submittedBody: 'We are checking it against our account. This page updates by itself as soon as it is confirmed.',
